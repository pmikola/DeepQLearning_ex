...
class SnakeGameRL:
    ...
    def is_collision(self, point=None):
        ...
        if point is None:
            point = self.head
        if point.x > self.w - BLOCK_SIZE or point.x < 0 or point.y > self.h - BLOCK_SIZE or self.head.y < 0:
            return True
        # hits itself
    ...
    def _move(self, action):
        # We can move straight, right or left
        # moving clock or counter clock_wise direction in one step
